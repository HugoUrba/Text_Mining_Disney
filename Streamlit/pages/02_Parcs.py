...
df = df[df['type de service'] == 'Parc']
st.sidebar.title("Filtres : ")
selected_status = st.sidebar.multiselect('Listing des Parcs :',['Disney Land Paris', 'Parc Walt Disney Studios'])
...
st.title("Analyses des Parcs Disneyland Paris")
