...
if selected_status == 'NewPort Bay Club':
    ...
    choix_note = st.sidebar.selectbox('Choix de la note des avis : ', 
    ...
    if choix_note == 'Tout le fichier':
        ...
        df = df 
    if choix_note == '1/5':
        st.dataframe(df[df.note == '1/5'])
        df = df[df.note == '1/5']
    if choix_note == '2/5':
        st.dataframe(df[df.note == '2/5'])
        df = df[df.note == '2/5']
    if choix_note == '3/5':
        st.dataframe(df[df.note == '3/5'])
        df = df[df.note == '3/5']
    if choix_note == '4/5':
        st.dataframe(df[df.note == '4/5'])
        df = df[df.note == '4/5']
    if choix_note == '5/5':
        st.dataframe(df[df.note == '5/5'])
        df = df[df.note == '5/5']
